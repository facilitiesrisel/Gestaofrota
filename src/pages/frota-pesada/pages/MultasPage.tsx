...
const MultasPage: React.FC = () => {
  ...
  const generateEmailHTML = (data: Partial<Multa>) => {
      ...
      return `
        <div style="font-family:'Plus Jakarta Sans', 'Segoe UI', -apple-system, BlinkMacSystemFont, Roboto, Arial, sans-serif;font-size:12pt;color:#334155;max-width:650px;border:1px solid #e2e8f0;border-radius:8px;overflow:hidden;background-color:#ffffff;">
          <div style="background-color:#022c22;padding:25px;text-align:center;"><h1 style="color:#00d664;margin:0;font-size:22px;font-family:'Plus Jakarta Sans','Segoe UI',sans-serif;letter-spacing:-0.5px;">NOTIFICAÇÃO DE MULTA</h1><p style="color:#cbd5e1;margin-top:5px;font-size:12px;">Gestão de Frotas Risel</p></div>
          <div style="padding:30px;">
            <p style="margin-bottom:20px;">Olá, seguem informações referentes a Notificação aplicada ao veículo:</p>
            ...
            <table style="width:100%;border-collapse:collapse;margin-top:15px;font-size:14px;font-family:'Plus Jakarta Sans','Segoe UI',sans-serif;">
              ...
              <tr style="background-color:#f1f5f9;"><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">${iconPlaca} Placa:</td><td style="padding:10px;border-bottom:1px solid #e2e8f0;">${data.placa || '-'}</td></tr>
              <tr><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">🏢 Base:</td><td style="padding:10px;border-bottom:1px solid #e2e8f0;">${data.base || '-'}</td></tr>
              <tr style="background-color:#f1f5f9;"><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">📅 Data:</td><td style="padding:10px;border-bottom:1px solid #e2e8f0;">${fmtDate(data.dataHoraInfracao)}</td></tr>
              <tr><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">⚠️ Infração:</td><td style="padding:10px;border-bottom:1px solid #e2e8f0;">${data.descricaoInfracao || '-'}</td></tr>
              <tr style="background-color:#f1f5f9;"><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">💲 Valor:</td><td style="padding:10px;color:#16a34a;font-weight:bold;border-bottom:1px solid #e2e8f0;">${fmtMoney(data.valorComDesconto)}</td></tr>
              <tr><td style="padding:10px;font-weight:bold;color:#022c22;border-bottom:1px solid #e2e8f0;">${iconCNH} Pontuação CNH:</td><td style="padding:10px;color:#334155;border-bottom:1px solid #e2e8f0;">${data.pontosCnh || '0'}</td></tr>
              <tr style="background-color:#f1f5f9;"><td style="padding:10px;font-weight:bold;color:#dc2626;border-bottom:1px solid #e2e8f0;">⏳ Prazo:</td><td style="padding:10px;font-weight:bold;color:#dc2626;border-bottom:1px solid #e2e8f0;">${fmtDate(data.prazoIndicacao)}</td></tr>
            </table>
            ${attachmentsSection}
          </div>
