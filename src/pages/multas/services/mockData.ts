...
export const mockCodigosMulta: CodigoMulta[] = [
  ...
  { codigo: '50020', baseLegal: 'Art. 257, § 8º', descricao: 'Multa NIC - Não Indicação de Condutor', pontos: 0, valor: 260.32, desconto: 0.00 },
  { codigo: '60501', baseLegal: 'Art. 208', descricao: 'Avançar o sinal vermelho do semáforo', pontos: 7, valor: 293.47, desconto: 58.70 },
];
